 ...
 * @constructor
**/
heeApp.State = function(main, callback){
  this.current;
  this.params = [];
...
heeApp.view = {
  ...
  init: function(){
    // var self = this;
    this.data;
    this.state = new heeApp.State(heeApp, heeApp.view.render); // initial state
  ...
  render: function(){
    var self = this;
    self.u.getJSON('data/data.json', function(data){
      var json = JSON.parse(data);
      self.u.addClass(self.u.getEl('#contents'), self.state.current);
      self[self.state.current] && self[self.state.current](json);
    });    
  },
  master: function(){
