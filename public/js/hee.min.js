...
heeApp.view = {
  ...
  detail: function(data){
    ...
    // set paging
    if(numPage === 0){
      u.addClass(u.getEl('#detail > header li:first-child'), 'hidden');
    } else {
      u.removeClass(u.getEl('#detail > header li:first-child'), 'hidden');
      u.getEl('#detail > header li:first-child a').href = '/#' + current + '/' + (parseInt(numPage) - 1);
    }
    if(numPage === (this.data.data.length - 1)){
      u.getEl('#detail > header li:last-child a').href = '/#summary';
    } else {
